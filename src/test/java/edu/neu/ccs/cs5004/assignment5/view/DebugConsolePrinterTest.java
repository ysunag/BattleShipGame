...
public class DebugConsolePrinterTest {
    private MapI testMap;
    private MapI testMap2;
    private DebugConsolePrinter testPrinter;
    private DebugConsolePrinter sameRefPrinter;
    private DebugConsolePrinter sameStatePrinter;
    private ConsolePrinter gamePrinter;
    private GameI game;
    ...
    public void setUp() throws Exception {
        ...
        testPrinter = new DebugConsolePrinter();
        sameStatePrinter = new DebugConsolePrinter();
        sameRefPrinter = testPrinter;
        gamePrinter = new GameConsolePrinter();
    ...
    @Test
    public void equals() {
        DebugConsolePrinter nullPrinter = null;
        DebugConsolePrinter anotherPrinter = new DebugConsolePrinter();
        ...
        Assert.assertFalse(testPrinter.equals(gamePrinter));
    }
    ...
    public void testHashCode() {
        ...
        Assert.assertEquals(!testPrinter.equals(gamePrinter),
                testPrinter.hashCode() != gamePrinter.hashCode());
    }
}